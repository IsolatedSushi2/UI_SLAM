...
"color: rgb(210, 210, 210);")
        ...
        self.leftButtonsFrame.setStyleSheet("background-color: rgb(28, 31, 36);")
        ...
        self.userLogo.setMinimumSize(QtCore.QSize(60, 60))
        self.userLogo.setMaximumSize(QtCore.QSize(60, 60))
...
"}")
        ...
        self.topBar.setMinimumSize(QtCore.QSize(0, 61))
        self.topBar.setMaximumSize(QtCore.QSize(16777215, 60))
        self.topBar.setStyleSheet("background-color: rgb(22, 22, 22);")
        ...
        self.notificationBar.setMaximumSize(QtCore.QSize(16777215, 50))
        self.notificationBar.setStyleSheet("background-color: rgb(22, 22, 22);")
...
"background-color: rgb(22, 22, 22);")
        ...
        self.mainStackedWidget.setStyleSheet("background-color: rgb(28, 31, 36);")
        ...
        self.verticalLayout_5.addWidget(self.cameraRenderPlace)
        ...
        self.horizontalLayout_12.setContentsMargins(0, 3, 0, 10)
        ...
        self.renderGroundTruthCheckBox.setMinimumSize(QtCore.QSize(200, 0))
        self.renderGroundTruthCheckBox.setMaximumSize(QtCore.QSize(200, 16777215))
        font = QtGui.QFont()
        font.setPointSize(13)
        self.renderGroundTruthCheckBox.setFont(font)
        self.renderGroundTruthCheckBox.setTristate(False)
        self.renderGroundTruthCheckBox.setObjectName("renderGroundTruthCheckBox")
        self.horizontalLayout_12.addWidget(self.renderGroundTruthCheckBox)
        self.renderModeledCheckBox = QtWidgets.QCheckBox(self.frame_3)
        self.renderModeledCheckBox.setMaximumSize(QtCore.QSize(150, 16777215))
        font = QtGui.QFont()
        font.setPointSize(13)
        self.renderModeledCheckBox.setFont(font)
        self.renderModeledCheckBox.setObjectName("renderModeledCheckBox")
        self.horizontalLayout_12.addWidget(self.renderModeledCheckBox)
        ...
        self.chart1Frame.setStyleSheet("background-color: rgb(28, 31, 36);")
        self.chart1Frame.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.chart1Frame.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.chart1Frame.setLineWidth(2)
        ...
        self.chart2Frame.setStyleSheet("background-color: rgb(28, 31, 36);")
        self.chart2Frame.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.chart2Frame.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.chart2Frame.setLineWidth(2)
        ...
        self.chart3Frame.setStyleSheet("background-color: rgb(28, 31, 36);")
        self.chart3Frame.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.chart3Frame.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.chart3Frame.setLineWidth(2)
        ...
        self.chart4Frame.setStyleSheet("background-color: rgb(28, 31, 36);")
        self.chart4Frame.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.chart4Frame.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.chart4Frame.setLineWidth(2)
        ...
        self.rangeSliderBar = QtWidgets.QFrame(self.centerFrame)
        self.rangeSliderBar.setMinimumSize(QtCore.QSize(0, 20))
        self.rangeSliderBar.setStyleSheet("background-color: rgb(28, 31, 36);")
        self.rangeSliderBar.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.rangeSliderBar.setFrameShadow(QtWidgets.QFrame.Raised)
        self.rangeSliderBar.setObjectName("rangeSliderBar")
        self.verticalLayout_13 = QtWidgets.QVBoxLayout(self.rangeSliderBar)
        self.verticalLayout_13.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_13.setSpacing(0)
        self.verticalLayout_13.setObjectName("verticalLayout_13")
        self.verticalLayout_3.addWidget(self.rangeSliderBar)
        ...
        self.informationBar.setStyleSheet("background-color: rgb(22, 22, 22);")
...
"background-color: rgb(22, 22, 22);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "This is a framework for developing SLAM algorithms"))
        self.label_6.setText(_translate("MainWindow", "Load in a dataset using the top 2 buttons to start"))
        self.label_7.setText(_translate("MainWindow", "Settings can be changed in the src/constants.py"))
        ...
        self.label_2.setText(_translate("MainWindow", "Position Error"))
        self.label_3.setText(_translate("MainWindow", "Rotation Error"))
        self.label_4.setText(_translate("MainWindow", "Velocity Change"))
        self.label_5.setText(_translate("MainWindow", "Number of Keypoints"))
